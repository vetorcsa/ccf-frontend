    ...
    return (
        <aside className="overflow-hidden rounded-lg border border-slate-200 bg-white lg:flex lg:h-full lg:min-h-0 lg:flex-col">
            ...
            {selectedFileId && !isLoading && errorMessage ? (
                <div className="px-5 py-5 lg:flex-1 lg:min-h-0 lg:overflow-y-auto">
                    <p className="rounded-lg border border-rose-100 bg-rose-50 px-3 py-4 text-sm text-rose-700">
                        {errorMessage}
                    </p>
                </div>
            ) : null}
                  ...
                  <span className="inline-flex rounded-full bg-blue-100 px-2.5 py-1 text-xs font-semibold text-blue-700">
                    ...
                    <footer className="border-t border-slate-200 bg-slate-50 px-5 py-4">
                        <button
                            ...
                            className="h-10 w-full rounded-md border border-slate-300 bg-white px-4 text-sm font-medium text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
                        >
